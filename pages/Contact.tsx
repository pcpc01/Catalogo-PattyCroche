  ...
  return (
    <div className="animate-fade-in py-16 container mx-auto px-4">
      <div className="grid lg:grid-cols-2 gap-16 overflow-hidden bg-white rounded-3xl shadow-xl border border-gray-100">
        ...
        {/* Info Column */}
        <div className="bg-patty-teal p-10 md:p-16 text-white flex flex-col justify-between relative overflow-hidden">
           {/* Decorative circles */}
           <div className="absolute -top-20 -right-20 w-64 h-64 bg-white/10 rounded-full blur-3xl"></div>
           <div className="absolute -bottom-20 -left-20 w-64 h-64 bg-patty-coral/30 rounded-full blur-3xl"></div>

           <div>
              <h2 className="font-serif text-4xl font-bold mb-6">Vamos Conversar?</h2>
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-white/60 mt-1">Seg - Sex, 9h às 18h</p>
                  </div>
                </div>
        ...
        <div className="p-10 md:p-16">
          <h2 className="font-serif text-3xl font-bold text-patty-graphite mb-2">Envie uma Mensagem</h2>
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="space-y-2">
              ...
              <select className="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:border-patty-teal focus:ring-1 focus:ring-patty-teal outline-none transition-all">
